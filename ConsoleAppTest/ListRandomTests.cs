...
namespace ConsoleAppTest
{
    public class ListRandomTests
    {
        ...
        public void SerializeDeserializeTest()
        {
            ...
            var currentExpectedNode = expectedList.Head;
            var currentActualNode = list.Head;

            for(; currentExpectedNode != null; currentExpectedNode = currentExpectedNode.Next, currentActualNode = currentActualNode.Next)
            {
